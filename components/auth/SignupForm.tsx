  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 bg-canvas-light rounded-lg border border-hairline-light shadow-paper-halo">
      <div className="mb-6 text-center">
        ...
        <p className="text-sm text-shade-50 mt-1">Start landing UK tech sponsor interviews with SponsorFlow</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center space-x-2 pt-1">
          <input
            ...
            className="h-4 w-4 rounded border-hairline-light text-primary focus:ring-primary"
          />
          <label htmlFor="terms" className="text-xs text-shade-60 cursor-pointer">
            I agree to the SponsorFlow Terms of Service and Privacy Policy
          </label>
        </div>
